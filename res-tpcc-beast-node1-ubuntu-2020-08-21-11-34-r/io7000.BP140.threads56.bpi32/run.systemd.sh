...
startmysql "--datadir=$DATADIR --innodb-io-capacity=$io --innodb_io_capacity_max=$iomax --innodb_buffer_pool_size=${BP}GB --innodb_buffer_pool_instances=$bpi  --innodb_adaptive_hash_index=0 --innodb_monitor_enable='%' --innodb_doublewrite_files=2 --innodb_doublewrite_pages=128 --innodb_change_buffering=none" &
