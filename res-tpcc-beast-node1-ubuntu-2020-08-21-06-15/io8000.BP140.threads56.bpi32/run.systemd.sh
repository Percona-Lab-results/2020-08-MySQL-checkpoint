...
MYSQLDIR=/mnt/data/vadim/servers/Percona-Server-8.0.20-11-Linux.x86_64.glibc2.12-minimal/
...
#startmysql "--datadir=$DATADIR --innodb-io-capacity=$io --innodb_io_capacity_max=$iomax --innodb_buffer_pool_size=${BP}GB --innodb_buffer_pool_instances=$bpi --innodb-page-cleaners=$bpi --innodb_adaptive_hash_index=0 --innodb_monitor_enable='%'  --innodb_doublewrite_files=2 --innodb_doublewrite_pages=128" &
startmysql "--datadir=$DATADIR --innodb-io-capacity=$io --innodb_io_capacity_max=$iomax --innodb_buffer_pool_size=${BP}GB --innodb_buffer_pool_instances=$bpi --innodb-page-cleaners=4 --innodb_adaptive_hash_index=0 --innodb_monitor_enable='%' --innodb_doublewrite_files=2 --innodb_doublewrite_pages=128 " &
# --innodb_doublewrite_files=2 --innodb_doublewrite_pages=64
sleep 10
waitmysql
